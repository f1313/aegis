    ...
    public boolean validateHostString ( String hostString ) {
        try {
            ...
            if ( ipMatcher.matches ( ) ) {
                ...
                The following is simplified by intelliJ Idea and I don't completely follow
                */
                return components.length != 5 || maskChecker ( components[ 4 ] );
                ...
                The following is simplified by intelliJ Idea and I don't completely follow
                */
                return ! hostString.contains ( "/" ) || maskChecker ( hostString.split ( "/" )[ 1 ] );
//String without mask specification
//Assuming true for now, might do a url checker later on.
